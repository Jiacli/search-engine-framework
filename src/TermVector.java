...
public class TermVector {
    ...
    public TermVector(int docId, String fieldName) throws IOException {
        ...
        for (int i = 1; ithTerm.next() != null; i++) {
            ...
            DocsAndPositionsEnum ithPositions = ithTerm.docsAndPositions(null,
                    null);
    ...
    /**
     * Get the number of positions in this field (the length of the field). If
    ...
    /**
     * Get the frequency of the n'th stem in the current doc, or -1 if the index
     * is invalid. The frequency for stopwords (i=0) is not stored (0 is
     * returned).
     * 
     * @param i
     *            Index of the stem
